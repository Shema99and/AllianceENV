...
//			final String tupleCreatedRes = service.createTuple(catalogId, reqinput, ServiceBase.getEntityAuth());
//			if (LOGGER.isInfoEnabled()) {
//				LOGGER.info("Tuple Creation Details :" + reqinput);
//				LOGGER.info("Tuple Created Response " + tupleCreatedRes);
//			}
//			final JSONObject jsonObject = new JSONObject(tupleCreatedRes);
