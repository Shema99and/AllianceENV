...
public class LockService extends ServiceBase {
	 ...
	 */
	public String getActivitiesCount(final String entityId) throws KeyManagementException, KeyStoreException,
	 ...
	 * @throws URISyntaxException
	 */
	public String isLocked(final String entityId, final Boolean includeChildren) throws KeyManagementException,
	 ...
	 * @throws URISyntaxException
	 */
	public String lockRecord(final String entityId) throws KeyManagementException, KeyStoreException,
			NoSuchAlgorithmException, CertificateException, IOException, URISyntaxException {
	 ...
	 * @throws URISyntaxException
	 */
	public String unlockRecord(final String entityId) throws KeyManagementException, KeyStoreException,
			NoSuchAlgorithmException, CertificateException, IOException, URISyntaxException {
		final String url = AppConstantsUtils.SERVICEBASE + AppConstantsUtils.ENTITYLOCKSERVICE + entityId + "/lock";
		return getRESTExecutor("Basic " + ServiceBase.getEntityAuth(), JsonConstantsUtils.ACCEPT,
